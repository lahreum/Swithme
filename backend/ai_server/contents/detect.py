...
def detect(image, detect_cnt):
    ...
    # hand_boxes, hand_scores, hand_classes, hand_nums = hand_yolo.predict(image_in)b

    # 결과
    result = detect_result((origin_boxes, origin_scores, origin_classes, origin_nums), origin_class_names, detect_cnt)
