...
public class GoogleOauth implements SocialOauth {
	...
	private final String clientId = "454862811715-9dc4r3up31iba5amemq1c7635ame41m6.apps.googleusercontent.com";
//	private final String clientId = "454862811715-f1k2ft42rkh2r02idn4q3mqdd8jmi6j9.apps.googleusercontent.com";
	private final String clientSecret = "itBCYVWBs_64Wm6jRh4FzK6g";
	...
	public String checkUserAccount(TokenInfo tokenInfo) {
		...
		if(optUserAccount.isPresent()) {	// 계정이 이미 존재할 경우
			if(optUserAccount.get().getUserType().equals("google")) {	// Google로 가입한 계정일 경우
				...
				redirectUri = "http://j4b103.p.ssafy.io/api/token?is-user=true&jwt-auth-token=" + jwtToken;
				return redirectUri;
			}
			else return "http://j4b103.p.ssafy.io/api/no-access/invalid_account";	// Google로 가입한 계정이 아닐 경우
		}
		...
		redirectUri = "http://j4b103.p.ssafy.io/api/token?is-user=false&jwt-auth-token=" + jwtToken;
